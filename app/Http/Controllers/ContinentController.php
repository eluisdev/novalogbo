...
class ContinentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.continents.index')->with('success', 'Continente creado correctamente.');
    }
    public function show($id)
    {
        $continent = Continent::findOrFail($id);
        if (!$continent) {
            return redirect()->route('admin.continents.index')->with('error', 'Continente no encontrado.');
        }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.continents.index')->with('success', 'Continente actualizado correctamente.');
    }
    ...
    public function destroy($id)
    {
        ...
        $continent->delete();
        return redirect()->route('admin.continents.index')->with('success', 'Continente eliminado correctamente.');
    }
    ...
    public function restore($id)
    {
        ...
        if (!$continent) {
            return redirect()->route('admin.continents.trashed')->with('error', 'Continente no encontrado.');
        }
        $continent->restore();
    ...
    public function forceDelete($id)
    {
        ...
        return redirect()->route('admin.continents.trashed')

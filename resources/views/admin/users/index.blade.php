                        ...
                        <tr class="user-row hover:bg-gray-50 transition-colors duration-150"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    ...
                                    {{ $user->role_id == '1' ? 'Administrador' : 'Operador' }}
                                </span>
                            </td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    noResultsRow.innerHTML = '<td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500">No se encontraron resultados</td>';

...
class ServiceController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if (!$service) {
            return redirect()->route('admin.services.index')->with('error', 'Servicio no encontrado.');
        }
    ...
    public function toggleStatus($id)
    {
        ...
        $service->save();
        return redirect()->route('admin.services.index')->with('success', 'Estado del servicio actualizado exitosamente.');
    }
}

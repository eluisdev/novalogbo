...
class IncotermController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.incoterms.index')->with('success', 'Incoterm creado exitosamente.');
    }
    ...
    public function show($id)
    {
        ...
        if (!$incoterm) {
            return redirect()->route('admin.incoterms.index')->with('error', 'Incoterm no encontrado.');
        }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.incoterms.index')->with('success', 'Incoterm actualizado exitosamente.');
    }

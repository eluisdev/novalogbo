        ...
        <tbody class="bg-white">
            ...
            <tr class="">
                ...
                <td class="p-2 flex items-center justify-center">
                    <a href="{{ route("users.edit", 1) }}" class="bg-yellow-500 hover:bg-yellow-700 w-8 h-8 rounded-full flex items-center">
                    ...
                    <form method="POST"
                    action="{{ route('users.destroy', $user->id) }}" id="delete-form"
                    >
                      @csrf
                      @method('DELETE')
                    <button

...
class CostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.costs.index')->with('success', 'Cost created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$cost) {
            return redirect()->route('admin.costs.index')->with('error', 'Cost not found.');
        }
    ...
    public function toggleStatus($id){
        ...
        return redirect()->route('admin.costs.index')->with('success', 'Cost status updated successfully.');
    }
}

...
<div class="p-6 border-b-2 border-blue-600">
    ...
    <div class="flex sm:flex-row flex-col gap-3 mt-2">
        <div class="flex items-center gap-3 my-2">
            <input type="checkbox" id="parallel_exchange_checkbox" name="parallel_exchange_checkbox"
                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                @if (old('juncture', isset($quotation_data) ? $quotation_data['formData']['juncture'] : '')) checked @endif>
        ...
        <div id="juncture_container" class="@if (!old('juncture', isset($quotation_data) ? $quotation_data['formData']['juncture'] : '')) hidden @endif">
            <div class="flex items-center gap-2 mt-1">
                <label for="juncture" class="whitespace-nowrap block text-sm font-medium text-gray-700 mb-1">Coyuntura
                    (Opcional) %</label>
                <input type="number" id="juncture" name="juncture" min="0" step="0.01" placeholder="0.00"

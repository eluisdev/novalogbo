...
<div class="relative overflow-x-auto max-w-6xl mx-auto">
    <div class="flex items-center justify-between bg-white my-5 p-2 px-4 rounded-full border-2 shadow-2xl">
        ...
        <a href="{{ route("clients.create") }}" class="bg-[#0B628D] hover:bg-[#2d4652] text-white rounded-sm p-2 text-sm font-semibold hover:cursor-pointer">Crear cliente</a>
    </div>
        ...
        <tbody class="bg-white">
            <tr class="">
                ...
                <td class="p-2 flex items-center justify-center">
                    <a href="{{ route("clients.edit") }}" class="bg-yellow-500 hover:bg-yellow-700 w-8 h-8 rounded-full flex items-center">

    ...
    <div class="bg-gray-300/70 h-dvh flex flex-col">
        <nav class="bg-white flex justify-between p-2 px-8 text-sm border-b-2">
            <div class="flex items-center gap-3">
                ...
                <span class="font-bold text-yellow-700">Administrador</span>
            </div>
            <div class="flex items-center gap-3">
        ...
        <section class="flex flex-1 h-full min-h-0">
            <div class="w-72 bg-[#dc8727] h-full overflow-y-scroll py-4 border-b-cyan-600">
                ...
                <ul class="text-center space-y-2 mt-4">
                    <li class="flex justify-between px-5">Usuarios <span class="font-semibold">5</span></li>
                    <li class="flex justify-between px-5">Cotizaciones <span class="font-semibold">5</span></li>
                    <li class="flex justify-between px-5">Historial <span class="font-semibold">5</span></li>
                    <li class="flex justify-between px-5">Configuracion <span class="font-semibold">5</span></li>
